 ...
 * <code>A method with the <code>Command</code> annotation can be wrapped in a
...
public interface ICommand {
  ...
  /**
   * The help messages. Will always be executed together, in the order of the
   * array.
   * 
  ...
  /**
   * The unique label. This is the label, prefixed with comma separated labels
   * of all parent commands.
   * 
  ...
  /**
   * Returns the usage string. This is a forward slash, followed by the unique
   * label, followed by the argument syntax.
   * 
  ...
  /**
   * Returns the labels of all nested commands. Not including children of
   * children.
   * 
   ...
   * 
   * @return true if this command has any nested commands, false if it has no
   *         nested commands
   */
  boolean hasNested();
}
