...
public class SelfServicePlugin extends JavaPlugin {
  ...
  private WorldGuardPlugin setupWorldGuard() {
    ...
    if (worldGuardPlugin == null || !(worldGuardPlugin instanceof WorldGuardPlugin)) {
      getLogger().log(Level.SEVERE,
          ChatColor.RED + " Couldn't find WorldGuard plugin. Please install WorldEdit and WorldGuard.");
      return null;
    } else {
  ...
  private IEconomy setupEconomy() {
    ...
    if (rsp == null) {
      getLogger().log(Level.SEVERE,
          ChatColor.RED + " Couldn't find Vault plugin. Please install Vault and an economy plugin.");
      return null;
    } else if (econ == null) {
      getLogger().log(Level.SEVERE, ChatColor.RED
          + " Vault couldn't find an economy plugin. Please install an economy plugin that is supported by Vault.");
      return null;
    } else {
