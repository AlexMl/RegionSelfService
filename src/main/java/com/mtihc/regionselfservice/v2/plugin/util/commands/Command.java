 ...
 * <p>
 * Class <code>SimpleCommand</code> will look for this annotion, when a
 * <code>Method</code> is added as a nested command.
 * </p>
 * 
 * @author Mitch
 */
...
public @interface Command {
  /**
   * Array of aliases for this command. The first alias is considered the
   * command label.
   * 
