...
public abstract class PlotSignText<T extends IPlotSignData> {
  ...
  /**
   * Create the object that is a subclass of <code>PlotSignText</code>. Could be
   * <code>ForSaleSignText</code> or <code>ForRentSignText</code>.
   * 
   * @param plotWorld
   *          The world data
   * @param lines
  ...
  public static class ForRentSignText extends PlotSignText<ForRentSignData> {
    ...
    /**
     * The player UUID that rented the region via this sign. Only defined when
     * rented out.
     * 
    ...
    /**
     * The time remaining for the player that rented the region via this sign.
     * Only defined when rented out.
     * 
